...
version = "1.2.0-WP2.5.13-SNAPSHOT"
...
dependencies {
    ...
    runtimeOnly(group = "org.pepsoft.worldpainter", name = "WPGUI", version = "2.5.13-SNAPSHOT") {
        exclude(module = "WPDynmapPreviewer")
    }
    compileOnly(group = "org.pepsoft.worldpainter", name = "WPCore", version = "2.5.13-SNAPSHOT")
}
